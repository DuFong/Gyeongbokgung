...
public class Restore2Activity extends AppCompatActivity {
    // 답이 2개인 문제에 대한 RestoreActivity.

    @BindView(R.id.input_reply2_1)
    EditText mAnswer2_1;
    @BindView(R.id.input_reply2_2)
    EditText mAnswer2_2;
    ...
    void input_answer() {
        ...
        String answer1 = mAnswer2_1.getText().toString();
        String answer2 = mAnswer2_2.getText().toString();
        ...
        Log.d(TAG,"1번입력 : "+answer1+" 1번 정답 : "+DBanswer1+"2번 입력 : "+answer2+"2번 정답 : "+DBanswer2);
        if((answer1.equals(DBanswer1)) && (answer2.equals(DBanswer2))){
            //답이 맞았을 때
