...
//        for (int i = 0; i < ssTitle.size(); i++) {
////            multiMap.put(mArrayList.get(i).getTitle(), mArrayList.get(i));
//            ssTitle.g
//            multiMap.put(ssTitle.get(i).getTitle(), ssTitle.get(i));
//        }
...
//        Multimap<String, Quest> subMultiMap = ArrayListMultimap.create();
//        for(String title:multiMap.keySet()){
//            List<Quest> quests = ((ArrayListMultimap<String, Quest>) multiMap).get(title);
//            for(int i=0;i<quests.size();i++){
//                subMultiMap.put(quests.get(i).getSubTitle(), quests.get(i));
//            }
//        }
//
