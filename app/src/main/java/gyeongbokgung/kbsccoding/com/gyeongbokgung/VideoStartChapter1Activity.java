...
public class VideoStartChapter1Activity extends AppCompatActivity {
    private Uri uri;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_video_start_chapter1);
        videoView = findViewById(R.id.video_start_chapter1);
        String uriPath = "android.resource://" + getPackageName() + "/" + R.raw.startchapter1;
