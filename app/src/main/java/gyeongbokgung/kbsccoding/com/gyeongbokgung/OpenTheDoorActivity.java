...
public class OpenTheDoorActivity extends AppCompatActivity {
    private Uri uri;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videoView = findViewById(R.id.open_the_door);
        String uriPath = "android.resource://" + getPackageName() + "/" + R.raw.openthedoor;
